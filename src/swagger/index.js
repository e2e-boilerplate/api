...
function getFramework(path) {
  ...
  if (path === "/platforms/nodejs/framework/index.json" || path === "/platforms/browser/framework/index.json") {
    return "framework";
  }

  if (path === "/platforms/nodejs/no_framework/index.json" || path === "/platforms/browser/no_framework/index.json") {
    return "no_framework";
  }
